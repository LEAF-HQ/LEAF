...
def Add_SingleElectron(SampleContainer):
...
def Add_SingleMuon(SampleContainer):
    SampleContainer.add_samples( {
...
def Add_Data(SampleContainer):
    Add_SingleElectron(SampleContainer)
    Add_SingleMuon(SampleContainer)
    Add_Tau(SampleContainer)
    Add_Met(SampleContainer)
