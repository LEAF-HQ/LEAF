...
The Submitter package is a helper tool for the [Analyzer](packages/analyzer). It allows for convenient yet efficient submission submission of jobs to the local cluster.
