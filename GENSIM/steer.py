...
def is_missing_shortfile(shortfilelist, jobname):
    ...
    # filenames = [f for f in os.listdir(crosssection_filepath) if isfile(join(crosssection_filepath, f)) and '_lo_' in f and not '_short' in f]
    # filenames_short = [f for f in os.listdir(crosssection_filepath) if isfile(join(crosssection_filepath, f)) and '_lo_' in f and '_short' in f]
    # filenames = [f for f in os.listdir(crosssection_filepath) if isfile(join(crosssection_filepath, f)) and '_lobw_' in f and not '_short' in f]
    # filenames_short = [f for f in os.listdir(crosssection_filepath) if isfile(join(crosssection_filepath, f)) and '_lobw_' in f and '_short' in f]
