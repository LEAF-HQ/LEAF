...
def main():
    for samplename in samplenames:
        ...
        Tuplizer = TuplizeRunner(sample=s, year='2017', config=config_per_year, workarea=workarea, basefolder=basefolder, gensimfolder=gensimfolder, macrofolder=macrofolder, submit=submit)
