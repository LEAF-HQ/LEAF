...
process = cms.Process('FLAT',Run2_2017)
...
# Output definition
process.out = OutputModule("NanoAODOutputModule",
    Configuration.EventContent.EventContent_cff.NANOAODEventContent.clone(),
    fileName = CfgTypes.untracked.string(outfilename))
