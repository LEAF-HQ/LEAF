...
# with command line options: step1 --fileout file:EXO-RunIIAutumn18MiniAOD-03472.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename EXO-RunIIAutumn18MiniAOD-03472_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 8597
...
# Run like:
###########
# cmsRun pset_miniaod_working.py infilename=../02GensimToDr/DR_step02_1.root nevents=100 nThreads=1 index=1
# cmsRun pset_miniaod_working.py infilename=../02GensimToAod/AOD_working_1.root outfilename=MINIAOD_working.root nevents=10 nThreads=5 index=1
