...
TauHists::TauHists(TString dir_) : BaseHists(dir_){
  ...
  htau1mass = book<TH1D>("tau1mass", ";m^{#tau 1} [GeV];Events / bin", 150, 0, 3000);
  htau1energy = book<TH1D>("tau1energy", ";E^{#tau 1} [GeV];Events / bin", 150, 0, 3000);
  htau2pt = book<TH1D>("tau2pt", ";p_{T}^{#tau 2} [GeV]; Events / bin", 150, 0, 3000);
  htau2eta = book<TH1D>("tau2eta", ";#eta^{#tau 2};Events / bin", 100, -5., 5.);
  htau2phi = book<TH1D>("tau2phi", ";#phi^{#tau 2};Events / bin", 70, -3.5, 3.5);
  htau2mass = book<TH1D>("tau2mass", ";m^{#tau 2} [GeV];Events / bin", 150, 0, 3000);
  htau2energy = book<TH1D>("tau2energy", ";E^{#tau 2} [GeV];Events / bin", 150, 0, 3000);
  htau3pt = book<TH1D>("tau3pt", ";p_{T}^{#tau 3} [GeV]; Events / bin", 150, 0, 3000);
  htau3eta = book<TH1D>("tau3eta", ";#eta^{#tau 3};Events / bin", 100, -5., 5.);
  htau3phi = book<TH1D>("tau3phi", ";#phi^{#tau 3};Events / bin", 70, -3.5, 3.5);
  htau3mass = book<TH1D>("tau3mass", ";m^{#tau 3} [GeV];Events / bin", 150, 0, 3000);
  htau3energy = book<TH1D>("tau3energy", ";E^{#tau 3} [GeV];Events / bin", 150, 0, 3000);
  htau4pt = book<TH1D>("tau4pt", ";p_{T}^{#tau 4} [GeV]; Events / bin", 150, 0, 3000);
  htau4eta = book<TH1D>("tau4eta", ";#eta^{#tau 4};Events / bin", 100, -5., 5.);
  htau4phi = book<TH1D>("tau4phi", ";#phi^{#tau 4};Events / bin", 70, -3.5, 3.5);
  htau4mass = book<TH1D>("tau4mass", ";m^{#tau 4} [GeV];Events / bin", 150, 0, 3000);
  htau4energy = book<TH1D>("tau4energy", ";E^{#tau 4} [GeV];Events / bin", 150, 0, 3000);
