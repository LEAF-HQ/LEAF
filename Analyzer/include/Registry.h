...
// Copied from the UHH2 analysis framework:
// https://github.com/UHH2/UHH2/blob/RunII_102X_v2/core/include/registry.h
...
private:
    ...
    std::map<TString, std::unique_ptr<Factory>> id_to_factory;
};
