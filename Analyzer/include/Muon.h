...
public:
  ...
  */
  ...
  Muon(){
    ...
    m_sim_pdgid = 0;
    m_sim_mother_pdgid = 0;
    m_sim_heaviestmother_flav = 0;
    m_jetidx = -1;
    m_dxy = -1;
    m_dz = -1;
    m_d0 = -1;
  ...
  GenPartFlav gen_part_flav() const {return m_gen_part_flav;};
  SimType sim_type() const {return m_sim_type;};
  int sim_pdgid() const {return m_sim_pdgid;};
  int sim_mother_pdgid() const {return m_sim_mother_pdgid;};
  int sim_heaviestmother_flav() const {return m_sim_heaviestmother_flav;};
  ...
  float iso_rel_04() const {return m_iso_rel_04;};
  ...
  float iso_tk() const {return m_iso_tk;};
  ...
  float tunep_pt() const {return m_tunep_pt;};
  float tunep_pt_err() const {return m_tunep_pt_err;};
  float tunep_eta() const {return m_tunep_eta;};
  float tunep_phi() const {return m_tunep_phi;};
  int tunep_numberOfValidMuonHits() const {return m_tunep_numberOfValidMuonHits;};
  ...
  int expectedNnumberOfMatchedStations() const {return m_expectedNnumberOfMatchedStations;};
  int set_numberOfMatchedRPCLayers() const {return m_numberOfMatchedRPCLayers;};
  ...
  bool innerTrack_isHighQuality() const {return m_innerTrack_isHighQuality;};
  int stationMask() const {return m_stationMask;};
