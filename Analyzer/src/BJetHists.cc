...
BJetHists::BJetHists(TString dir_) : BaseHists(dir_){
  ...
  hbjetloosedeepb = book<TH1D>("bjetloosedeepb", ";DeepJet score (all bjets loose);Events / bin", 50, 0, 1);
  ...
  hbjetloose1deepb = book<TH1D>("bjetloose1deepb", ";DeepJet score (bjetloose 1);Events / bin", 50, 0, 1);
  ...
  hnotbjetloosedeepb = book<TH1D>("notbjetloosedeepb", ";DeepJet score (all notbjets loose);Events / bin", 50, 0, 1);
  ...
  hnotbjetloose1deepb = book<TH1D>("notbjetloose1deepb", ";DeepJet score (notbjetloose 1);Events / bin", 50, 0, 1);
  ...
  hbjetmediumdeepb = book<TH1D>("bjetmediumdeepb", ";DeepJet score (all bjets medium);Events / bin", 50, 0, 1);
  ...
  hbjetmedium1deepb = book<TH1D>("bjetmedium1deepb", ";DeepJet score (bjetmedium 1);Events / bin", 50, 0, 1);
  ...
  hnotbjetmediumdeepb = book<TH1D>("notbjetmediumdeepb", ";DeepJet score (all notbjets medium);Events / bin", 50, 0, 1);
  ...
  hnotbjetmedium1deepb = book<TH1D>("notbjetmedium1deepb", ";DeepJet score (notbjetmedium 1);Events / bin", 50, 0, 1);
  ...
  hbjettightdeepb = book<TH1D>("bjettightdeepb", ";DeepJet score (all bjets tight);Events / bin", 50, 0, 1);
  ...
  hbjettight1deepb = book<TH1D>("bjettight1deepb", ";DeepJet score (bjettight 1);Events / bin", 50, 0, 1);
  ...
  hnotbjettightdeepb = book<TH1D>("notbjettightdeepb", ";DeepJet score (all notbjets tight);Events / bin", 50, 0, 1);
  ...
  hnotbjettight1deepb = book<TH1D>("notbjettight1deepb", ";DeepJet score (notbjettight 1);Events / bin", 50, 0, 1);
...
void BJetHists::fill(const RecoEvent & event){
  ...
  for(size_t i=0; i<njets; i++){
    ...
    if(is_loose){
      ...
      hbjetloosedeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(ndeepbloose == 1){
        ...
        hbjetloose1deepb->Fill(j.score_DeepFlavB(), weight);
      ...
      hnotbjetloosedeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(i-ndeepbloose == 1){
        ...
        hnotbjetloose1deepb->Fill(j.score_DeepFlavB(), weight);
    ...
    if(is_medium){
      ...
      hbjetmediumdeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(ndeepbmedium == 1){
        ...
        hbjetmedium1deepb->Fill(j.score_DeepFlavB(), weight);
      ...
      hnotbjetmediumdeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(i-ndeepbmedium == 1){
        ...
        hnotbjetmedium1deepb->Fill(j.score_DeepFlavB(), weight);
    ...
    if(is_tight){
      ...
      hbjettightdeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(ndeepbtight == 1){
        ...
        hbjettight1deepb->Fill(j.score_DeepFlavB(), weight);
      ...
      hnotbjettightdeepb->Fill(j.score_DeepFlavB(), weight);
      ...
      if(i-ndeepbtight == 1){
        ...
        hnotbjettight1deepb->Fill(j.score_DeepFlavB(), weight);
