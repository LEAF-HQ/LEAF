...
# Other statements
from PSets.UL18.mixdata_Summer20 import mixdatalist
process.mixData.input.fileNames = cms.untracked.vstring(mixdatalist)
from Configuration.AlCa.GlobalTag import GlobalTag
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_upgrade2018_realistic_v11_L1v1', '')

# Path and EndPath definitions
process.simulation_step = cms.Path(process.psim) # added by hand to skip the standalone sim-step
