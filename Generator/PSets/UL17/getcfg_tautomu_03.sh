...
cmsDriver.py  --python_filename B2G-RunIISummer20UL17DIGIPremix-00013_1_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --fileout file:B2G-RunIISummer20UL17DIGIPremix-00013.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL17_106X_mc2017_realistic_v6-v3/PREMIX" --conditions 106X_mc2017_realistic_v6 --step SIM,DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --nThreads 8 --geometry DB:Extended --filein file:B2G-RunIISummer20UL17SIM-00013.root --datamix PreMix --era Run2_2017 --runUnscheduled --no_exec --mc -n 2104
