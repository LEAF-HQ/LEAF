        ...
        for processname in self.processnames:
            for individual_setting in self.individual_settings:
                ...
                if mode is 'new':
                    ...
                    indices = missing_indices = findMissingFilesT3(filepath=self.T2_director_root+self.T2_path+'/'+self.folderstructure[generation_step]['pathtag']+'/'+jobname, filename_base=self.folderstructure[generation_step]['outfilenamebase'], maxindex=self.maxindex, treename='Events')
