...
processes = ['SingleTth_THad_Hbb_MT2000_MH170'] # (new) 200*1000 events
...
# EventGenerator.SubmitGridpacks(ncores=4)
# EventGenerator.MoveGridpacks()
# EventGenerator.SubmitGenerationStepSM(generation_step='GENSIM', ncores=4, runtime=(3,00,00), mode='new')
# EventGenerator.SubmitGenerationStepSM(generation_step='GENSIM', ncores=4, runtime=(3,00,00), mode='resubmit')
# EventGenerator.SubmitGenerationStepSM(generation_step='GENSIM', ncores=8, runtime=(3,00,00), mode='resubmit')
# EventGenerator.SubmitGenerationStepSM(generation_step='DR', ncores=8, runtime=(6,00,00), mode='new')
# EventGenerator.SubmitGenerationStepSM(generation_step='DR', ncores=8, runtime=(6,00,00), mode='resubmit')
